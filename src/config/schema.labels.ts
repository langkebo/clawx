...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.nodes.allowPrivateNetwork": "Gateway Node Allow Private Network",
  ...
  "viking.enabled": "Viking Routing Enabled",
  "viking.cacheMaxSize": "Cache Max Size",
  "viking.cacheTtlMs": "Cache TTL (ms)",
  "viking.ruleEngine": "Rule Engine",
  "viking.dynamicReroute": "Dynamic Reroute",
  "viking.postCompactReroute": "Post-Compact Reroute",
  "viking.modelSwitching": "Model Switching",
  "viking.parallelRouting": "Parallel Routing",
  "viking.feedbackLoop": "Feedback Loop",
  "viking.routingModel": "Routing Model",
};
