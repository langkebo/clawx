...
type MessageContent = string | TextContentBlock[];

function extractTextFromContent(content: MessageContent): string | undefined {
  if (typeof content === "string") {
    return content;
  }
  return content.find((c): c is TextContentBlock => c.type === "text")?.text;
}
