...
export const zh_TW: TranslationMap = {
  ...
  overview: {
    ...
    viking: {
      ...
      P4: "規則引擎",
      P5: "反饋循環",
      configTitle: "Viking 路由配置",
      configDesc: "智能路由、快取和優化設定。",
      routeTag: "Viking 路由",
    },
  },
  usage: {
    vikingRouting: "Viking 路由",
    vikingRoutingDisabled: "路由已禁用",
    cacheHitRate: "快取命中率",
    ruleEngineHits: "規則引擎命中",
    reroutes: "重路由",
    dynamicRerouteActive: "動態重路由活躍",
    noReroutesNeeded: "無需重路由",
    noRoutingData: "無路由數據",
  },
  chat: {
